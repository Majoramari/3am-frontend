...
type VideoGalleryConfig = {
	slides: ReadonlyArray<VideoSlide>;
	headline?: string;
};

export class VideoGallery extends View<"section"> {
	private readonly slides: ReadonlyArray<VideoSlide>;
	private readonly headline: string;

	constructor(config: VideoGalleryConfig) {
		super("section", { className: "video-gallery" });
		...
		return this.tpl`
			<div class="viewport-content">
				<header class="section-header">
					<h2 class="section-header-headline">${this.headline}</h2>
				</header>
			</div>

			<div class="media-card-gallery-content">
				<div class="vg-controls">

					<div class="vg-dotnav">
						<span class="vg-controls__bg"></span>
						<ul role="tablist" class="dotnav-items" id="dotnavItems"></ul>
					</div>

					<div class="vg-play-pause-wrapper">
						<span class="vg-controls__bg"></span>
						<button class="vg-play-pause-btn" id="playPauseBtn" aria-label="Play gallery">
							<span class="visuallyhidden">Play</span>
							<svg class="icon icon--play" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 56 56" aria-hidden="true">
							...
							<svg class="icon icon--pause" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 56 56" aria-hidden="true">
							...
							<svg class="icon icon--replay" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 56 56" aria-hidden="true">
